...
реализацией для каждого запроса. Это создает сложности для разработчики. Прдеставляем вам способ снять с себя нагрузку
описания запроса и оставить только контроль по его выполнению.
